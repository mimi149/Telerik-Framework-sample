...
(function() {
    var provider = app.data.frameworkSample = new Everlive({
            offlineStorage: true,
            appId: 'behgg4gi32e5zulr',
            scheme: 'https',
            authentication: {
                persist: true
            }
        }),
        accessTokenCacheKey = 'frameworkSample_access_token',
...
// START_CUSTOM_CODE_frameworkSample
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_frameworkSample